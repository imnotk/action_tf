...
from model import net, resnet, inception_v1
...
class model ():
    ...
    def init_dataset(self):
        ...
        if dataset == 'UCF101':
            self.dataset = ucf_2d.ucf_dataset (split_number=split, is_training_split=False,
                                                      batch_size=self.batch_size, epoch=1,
                                                      eval_type='joint',frame_counts=self._FRAME_COUNTS,
        ...
        while  True:
            try:
                ...
                for i in range(self.batch_size):
                    ...
                    # out_logit = sess.run([model_predictions],feed_dict=feed_dict)
