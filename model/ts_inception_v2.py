...
class InceptionV2(snt.AbstractModule):
    ...
    def _build(self, inputs ,is_training ,dropout_keep_prob = 1.0):
        ...
        conv0 = Unit3d(output_channels=64,kernel_shape=[7,7],use_batch_norm=False,depthwise=True,
                     stride=[2,2],name = end_point)
        frame_count = net.shape.as_list()[1]
        input_frame = tf.split(net,frame_count,axis=1)
        net_list = []
        for sub_frame in input_frame:
            net_list.append(conv0(sub_frame[:,0,...],is_training=True))
        net = tf.stack(net_list,axis=1)
        ...
        with tf.variable_scope(end_point):
            ...
            with tf.variable_scope('Branch_1'):
                branch_1 = Unit3d(output_channels=64,kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net,is_training=is_training & _use_bn )
                branch_1 = Unit3d(output_channels=64,kernel_shape=(1,3,3),
            ...
            with tf.variable_scope('Branch_3'):
                branch_3 = tf.nn.avg_pool3d(net,ksize=(1,1,3,3,1),
        ...
        with tf.variable_scope(end_point):
            ...
            with tf.variable_scope('Branch_1'):
                branch_1 = Unit3d(output_channels=64, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn )
                branch_1 = Unit3d(output_channels=96, kernel_shape=(1,3,3),
        ...
        with tf.variable_scope (end_point):
            with tf.variable_scope ('Branch_0'):
                branch_0 = Unit3d (output_channels=128, kernel_shape=(1,1,1),
                                   name='Conv2d_0a_1x1') (net, is_training=is_training & _use_bn )
                branch_0 = Unit3d (output_channels=160, kernel_shape=(1,3,3),stride=(1,2,2),
            ...
            with tf.variable_scope('Branch_1'):
                ...
                branch_1 = Unit3d(output_channels=96, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_1,
                                                        is_training=is_training & _use_bn)
                branch_1 = Unit3d (output_channels=96, kernel_shape=(1,3,3),stride=(1,2,2),
                                   name='Conv2d_1a_3x3') (branch_1,
                                                          is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_2'):
                branch_2 = tf.nn.max_pool3d(net, ksize=(1,1,3,3,1),
                                            strides=(1,1,2,2,1), padding=snt.SAME,
                                            name='MaxPool_0a_3x3')
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('Branch_0'):
                branch_0 = Unit3d(output_channels=224, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_1'):
                branch_1 = Unit3d(output_channels=64, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
                branch_1 = Unit3d(output_channels=96, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_1,
                                                        is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_2'):
                branch_2 = Unit3d(output_channels=96, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
        ...
        with tf.variable_scope(end_point):
            ...
            with tf.variable_scope('Branch_1'):
                branch_1 = Unit3d(output_channels=128, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
                branch_1 = Unit3d(output_channels=160, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_1,
                                                        is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_2'):
                branch_2 = Unit3d(output_channels=128, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
                branch_2 = Unit3d(output_channels=160, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_2,
                                                        is_training=is_training & _use_bn)
                branch_2 = Unit3d (output_channels=160, kernel_shape=(1,3,3),
                                   name='Conv2d_0c_3x3') (branch_2,
            ...
            with tf.variable_scope('Branch_1'):
                ...
                branch_1 = Unit3d(output_channels=192, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_1,
                                                        is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_2'):
                branch_2 = Unit3d(output_channels=160, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
                branch_2 = Unit3d(output_channels=192, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_2,
                                                        is_training=is_training & _use_bn)
                branch_2 = Unit3d (output_channels=192, kernel_shape=(1,3,3),
                                   name='Conv2d_0c_3x3') (branch_2,
        ...
        with tf.variable_scope (end_point):
            ...
            with tf.variable_scope ('Branch_1'):
                ...
                branch_1 = Unit3d (output_channels=256, kernel_shape=(1,3,3),
                                   name='Conv2d_0b_3x3') (branch_1,
                                                          is_training=is_training & _use_bn)
                branch_1 = Unit3d (output_channels=256, kernel_shape=(1,3,3),stride=(1,2,2),
                                   name='Conv2d_1a_3x3') (branch_1,
                                                          is_training=is_training & _use_bn)
        ...
        with tf.variable_scope(end_point):
            with tf.variable_scope('Branch_0'):
                branch_0 = Unit3d(output_channels=352, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
            with tf.variable_scope('Branch_1'):
                branch_1 = Unit3d(output_channels=192, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
            ...
            with tf.variable_scope('Branch_2'):
                branch_2 = Unit3d(output_channels=160, kernel_shape=(1,1,1),
                                  name='Conv2d_0a_1x1')(net, is_training=is_training & _use_bn)
                branch_2 = Unit3d(output_channels=224, kernel_shape=(1,3,3),
                                  name='Conv2d_0b_3x3')(branch_2,
                                                        is_training=is_training & _use_bn)
                branch_2 = Unit3d (output_channels=224, kernel_shape=(1,3,3),
                                   name='Conv2d_0c_3x3') (branch_2,
...
if __name__ == "__main__":
    ...
    with tf.variable_scope('Flow'):
        _ ,e = InceptionV2(num_classes=1000)(inputs,is_training=True)
        rgb_var_map = {}
    ...
    #     ckpt = tf.train.get_checkpoint_state(r'E:/zhujian/action_recognition/data/flow_snt_inception_v2')
    #     if ckpt is not None:
